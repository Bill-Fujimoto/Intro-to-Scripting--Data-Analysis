...
##    print()
    ...
    # Test the writer
##    cancer_risk_table = read_csv_file("test_case.csv")
##    write_csv_file(test_table, "test_case_copy.csv")
##    test_table_copy = read_csv_file("test_case_copy.csv")
##    print_table(test_table_copy)
...
##    print(test_table == test_table_copy)
    print(cancer_risk_table == cancer_risk_copy)
    # Test whether two tables are the same (Course Solution)
